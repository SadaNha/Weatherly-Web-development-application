...
// $("#conimg").src=data.current.condition.icon;
 ...
 fetch(
   ...
   `http://api.weatherapi.com/v1/forecast.json?q=${lati},${longi}&key=e0939844aa0b4acaaa3153652233005&days=2`,
   {
      method : "GET",
      mode : "cors"
   }
...
$(".searchBtn").click(function () {
   ...
   localStorage.setItem("LocationRequired",searchedLocation);
